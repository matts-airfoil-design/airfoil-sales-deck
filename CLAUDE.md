...
- Deck manifests belong in `manifests/` (create the directory with the first manifest; none is committed yet — the shape is in the skill's `references/manifest.md`). Validate a manifest before and after editing it:
